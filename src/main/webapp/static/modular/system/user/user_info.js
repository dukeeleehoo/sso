...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar').set('mobile').set('majorposition').set('rank')
...
UserInfoDlg.addSubmit = function () {
    ...
    var applicationids = document.getElementsByName("applicationids");
    var check_val = [];
    for(k in applicationids){
        if(applicationids[k].checked)
            check_val.push(applicationids[k].value);
    }
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/mgr/add?check_val="+check_val, function (data) {
        Feng.success("添加成功!");
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/mgr/edit?check_val="+check_val, function (data) {
        Feng.success("修改成功!");
...
$(function () {
    ...
    $("#majorposition").val($("#majorpositionValue").val());
    $("#rank").val($("#rankValue").val());
    ...
    var checkeds = $("#applicationidsValue").val();
    var checkArray =checkeds.split(",");
    var checkBoxAll = $("input[name='applicationids']");
