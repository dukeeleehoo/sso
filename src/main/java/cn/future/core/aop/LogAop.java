 ...
 */
package cn.future.core.aop;

import cn.future.core.common.annotion.BussinessLog;
import cn.future.core.common.constant.dictmap.base.AbstractDictMap;
...
import cn.future.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(cn.future.core.common.annotion.BussinessLog)")
