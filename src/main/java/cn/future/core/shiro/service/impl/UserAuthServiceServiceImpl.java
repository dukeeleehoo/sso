 ...
 */
package cn.future.core.shiro.service.impl;
...
import cn.future.modular.system.dao.MenuMapper;
...
public class UserAuthServiceServiceImpl implements UserAuthService {
    ...
    @Override
    public User getUesrByToken(String token) {
        Wrapper<User> userWrapper = new EntityWrapper<>();
        userWrapper.eq("token", token);
