...
import cn.future.core.common.constant.dictmap.NoticeMap;
...
import cn.future.modular.system.model.Dict;
import cn.future.modular.system.model.Notice;
import cn.future.modular.system.service.IDictService;
import cn.future.modular.system.service.INoticeService;
import cn.future.modular.system.warpper.NoticeWrapper;
...
public class NoticeController extends BaseController {
    ...
    public String noticeAdd(Model model) {
        List<Dict> colors = dictService.selectByParentCode("article_color");
     ...
     * 跳转到查看通知
     */
    @RequestMapping("/find/{noticeId}")
    public String find(@PathVariable Integer noticeId, Model model) {
        Notice notice = this.noticeService.selectById(noticeId);
        model.addAttribute("notice", notice);
        LogObjectHolder.me().set(notice);
        return PREFIX + "notice_find.html";
    }
