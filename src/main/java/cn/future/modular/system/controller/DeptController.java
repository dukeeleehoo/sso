...
import cn.future.core.common.constant.dictmap.DeptDict;
...
import cn.future.modular.system.service.IDeptService;
import cn.future.modular.system.service.IPushService;
import cn.future.modular.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public Object update(Dept dept) {
        ...
        //调用推送接口。
        pushService.pushDept(dept,"update");
        return SUCCESS_TIP;
    }
    ...
    public Object delete(@RequestParam Integer deptId) {
        ...
        //调用推送接口。
        pushService.pushDept(deptService.selectById(deptId),"delete");
        return SUCCESS_TIP;
    }
