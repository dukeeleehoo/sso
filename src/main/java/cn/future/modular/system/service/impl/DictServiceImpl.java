...
import cn.future.core.common.constant.factory.MutiStrFactory;
import cn.future.core.common.exception.BizExceptionEnum;
import cn.future.modular.system.dao.DictMapper;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    @Override
    public Dict selectByParentAndCode(String code, String pcode) {
        return this.baseMapper.selectByParentAndCode(code,pcode);
    }
}
