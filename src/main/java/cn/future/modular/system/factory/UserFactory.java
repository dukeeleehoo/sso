 ...
 */
package cn.future.modular.system.factory;
...
public class UserFactory {
    ...
    public static User editUser(UserDto newUser, User oldUser) {
        if (newUser == null || oldUser == null) {
            ...
            if (ToolUtil.isNotEmpty(newUser.getMajorposition())) {
                oldUser.setMajorposition(newUser.getMajorposition());
            }
            if (ToolUtil.isNotEmpty(newUser.getRank())) {
                oldUser.setRank(newUser.getRank());
            }
            if (ToolUtil.isNotEmpty(newUser.getDeputypostone())) {
                oldUser.setDeputypostone(newUser.getDeputypostone());
            }
            oldUser.setApplicationids(newUser.getApplicationids());
            return oldUser;
        }
    }
}
