...
public class UserWarpper extends BaseControllerWrapper {
    ...
    protected void wrapTheMap(Map<String, Object> map) {
        ...
        map.put("majorpositionName", ConstantFactory.me().getMajorpositionName((Integer) map.get("majorposition")));
        map.put("rankName", ConstantFactory.me().getRankName((Integer) map.get("rank")));
    }
